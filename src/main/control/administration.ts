...
export function createAdministration(input: {
  ...
  const handlers = new Map<string, (...args: unknown[]) => unknown>([
    ...
    ["telegram.unpair", (id) => input.service.unpairTelegram(idSchema.parse(id))],
    ["telegram.disconnect", (id) => input.service.disconnectTelegram(idSchema.parse(id))],
    ["discord.status", () => input.service.discordStatus()],
    ["discord.configure", (value) => input.service.configureDiscord(validation.configureDiscordSchema.parse(value))],
